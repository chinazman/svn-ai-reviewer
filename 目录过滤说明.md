...
**逻辑�?*
- SVN log的XML输出中，目录路径通常�?`/` 结尾
- 例如：`/trunk/src/` 是目录，`/trunk/src/Main.java` 是文�?
- 通过检查路径后缀来过滤目�?
...
### 修改的函�?
- `GetChangedFiles()` - 本地模式，添加目录检�?
- `GetRevisionFiles()` - 在线模式，添加路径后缀检�?
