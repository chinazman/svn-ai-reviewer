...
### 4. 分页浏览
- 支持查看上100条/下100条记录（类似TortoiseSVN）
- 保持搜索条件不变
...
### 场景2：审核特定功能的代码
```bash
svn-reviewer review online --keyword "用户登录" --path /trunk/src/auth
# 搜索包含"用户登录"关键词的提交
```

### 场景3：审核历史bug修复
```bash
svn-reviewer review online --keyword "bug" --author lisi
# 搜索lisi提交的包含"bug"的记录
```
